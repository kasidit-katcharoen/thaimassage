      ...
      <div class="col-xl-7 col-12">
        <div class="card border-0 shadow pb-2">
          <div class="card-body text-center">
            <div class="txt01 py-1 fw-bold txt18">ข่าวสารและกิจกรรม</div>
            <div class="row justify-content-center">
              <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-8  px-0">
                <input type="text"class="form-control py-1 shadow-none" id="search_news_menu" placeholder="ค้นหาข่าว">
              </div>
              <div class="col-auto px-0">
                <button type="button" class="btn btn-primary rounded-3 py-2 shadow-none"><i class="fas fa-search"></i></button>
              </div>
            </div>
          </div>
        </div>
