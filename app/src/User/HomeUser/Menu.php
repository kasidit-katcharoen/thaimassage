      ...
      <div id="carouselExampleFade1" class="carousel slide carousel-fade " data-bs-ride="carousel">
        <div class="carousel-inner col-auto rounded-3">
          <div class="carousel-item active">
            <img src="Img/ImgWeb/imgboad01.png" class="w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="Img/ImgWeb/imgboad02.png" class="w-100" alt="...">
          </div>
          <div class="carousel-item">
            <img src="Img/ImgWeb/imgboad04.png" class="w-100" alt="...">
          </div>
        </div>
  ...
  <div class="row justify-content-center">
    <div class="col-12 px-2">
      <div id="carouselExampleFade02" class="carousel slide carousel-fade" data-bs-ride="carousel">
        <div class="carousel-inner col-auto rounded-3">
          <div class="carousel-item active">
            <img src="Img/ImgWeb/imgboad01.png" class="img-fluid col-12" width="100%">
          </div>
          <div class="carousel-item">
            <img src="Img/ImgWeb/imgboad02.png" class="img-fluid col-12" width="100%">
          </div>
          <div class="carousel-item">
            <img src="Img/ImgWeb/imgboad04.png" class="img-fluid col-12" width="100%">
          </div>
        </div>
