        ...
        <div class="card-body pt-0">
          <div class="row justify-content-center mt-2">
                      ...
                      <div class="card-body pb-0 px-1 py-1">
                        <div class="row justify-content-start">
                          ...
                          <div class="row justify-content-start my-0 text-break">
                            <div class="col-auto ps-3 mt-2 txt13" id="click_show_content'.$news_id.'" style=line-height:20px;>
                              '.$news_content.'
                            </div>
                          </div>
                        </div>
                      ...
                      <div class="row justify-content-center">
                        ...
                        <div class="row justify-content-center">
                          <div class="col-auto px-1 mt-2 txt13">
                            <span class="text-secondary">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;คลินิกการแพทย์แผนไทย โรงพยาบาลมหาราชนครราชสีมา ตั้งอยู่ที่ <i class="fa fa-map-marker txt01" aria-hidden="true"></i> เลขที่ 49 ถนน ช้างเผือก ตำบลในเมือง อำเภอเมืองนครราชสีมา จังหวัดนครราชสีมา รหัสไปรษณีย์ 30000</span>
                          </div>
            ...
            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12 text-center pt-2 d-xl-block d-lg-block d-md-block d-sm-none d-none">
              ...
              <span class="text-secondary text-center txt13 col-12"> คลินิกการแพทย์แผนไทย โรงพยาบาลมหาราชนครราชสีมา</span>
